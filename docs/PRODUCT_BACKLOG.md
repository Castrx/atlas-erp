...
| ID | Item | Área | Prioridade | Status |
|---|---|---|---|---|
| AE-030 | Fluxo de CRUD de Produtos — cadastro, edição e exclusão (listagem já implementada, ver Sprint 4A no [Roadmap](ROADMAP.md)) | frontend | 🔴 | em andamento |
| AE-031 | Tela e fluxo de CRUD de Clientes | frontend | 🔴 | todo |
